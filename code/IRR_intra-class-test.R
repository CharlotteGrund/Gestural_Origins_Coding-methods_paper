...
xx1$MAU_duration <- round(xx1$MAU_duration, digits = 1)
xx1$GA_duration <- round(xx1$GA_duration, digits = 1)
...
xx2$MAU_duration <- round(xx2$MAU_duration, digits = 1)
xx2$GA_duration <- round(xx2$GA_duration, digits = 1)
...
xx1$GA.outcome.lat <- round(xx1$GA.outcome.lat, digits = 1)
xx1$MAU.outcome.lat <- round(xx1$MAU.outcome.lat, digits = 1)
...
xx2$GA.outcome.lat <- round(xx2$GA.outcome.lat, digits = 1)
xx2$MAU.outcome.lat <- round(xx2$MAU.outcome.lat, digits = 1)

## Selection of timings (linked through Rec_number)
# Coder 1
...
## Selection of relevant timings linked through Rec_number
# Coder 1
